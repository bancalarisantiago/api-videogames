...
module.exports = {  
    ...
    fetchGames: async function () {
        ...
        try {
                const promisesArray = [];
                    ...
                    let allGames = axios.get(`${API_URL}/games?page=${page}&key=${API_KEY}`)
    ...
    findByName : async function (name) {
                ...
                try {
                    const gamesByName = await axios.get(`${API_URL}/games?search=${name}&key=${API_KEY}`)     
                    return gamesByName
        ...
        fetchPlatforms : async function () {
            ...
            try {
                ...
                const allPlatforms = await axios.get(`${API_URL}/platforms?key=${API_KEY}`)
                return allPlatforms
            } catch(error) {
                console.log(error)
